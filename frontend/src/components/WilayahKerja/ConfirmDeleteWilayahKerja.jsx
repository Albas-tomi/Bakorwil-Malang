...
const ConfirmDeleteWilayahKerja = ({ pickIdDelete, deleteWilayahKerjaId }) => {
  return (
    <div>
      <dialog id="my_modal_confirmDeleteWilayahKerja" className="modal">
        <form method="dialog" className="modal-box">
          <div className=" flex flex-col items-center justify-center">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => {
                  window.my_modal_confirmDeleteWilayahKerja.close();
                }}
              ...
              <button
                onClick={() => deleteWilayahKerjaId(pickIdDelete)}
...
export default ConfirmDeleteWilayahKerja;
