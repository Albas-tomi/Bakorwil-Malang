...
const ConfirmDeletePengumuman = ({ pickIdDelete, deletePengumumanId }) => {
  return (
    <div>
      <dialog id="my_modal_confirmDeletePengumuman" className="modal">
        <form method="dialog" className="modal-box">
          <div className=" flex flex-col items-center justify-center">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => {
                  window.my_modal_confirmDeletePengumuman.close();
                }}
              ...
              <button
                onClick={() => deletePengumumanId(pickIdDelete)}
...
export default ConfirmDeletePengumuman;
