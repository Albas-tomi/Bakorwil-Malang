...
const ConfirmDeleteDokumen = ({ deleteDokumenId, pickIdDelete }) => {
  return (
    <dialog id="my_modal_confirmDeleteDokumen" className="modal">
      <form method="dialog" className="modal-box">
        <div className=" flex flex-col items-center justify-center">
          ...
          <div className="flex gap-4">
            <button
              onClick={() => {
                window.my_modal_confirmDeleteDokumen.close();
              }}
            ...
            <button
              onClick={() => deleteDokumenId(pickIdDelete)}
...
export default ConfirmDeleteDokumen;
