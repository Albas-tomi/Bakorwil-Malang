...
const ConfirmDeletePPID = ({ deletePPIDId, pickIdDelete }) => {
  return (
    <dialog id="my_modal_confirmDeletePPID" className="modal">
      <form method="dialog" className="modal-box">
        <div className=" flex flex-col items-center justify-center">
          ...
          <div className="flex gap-4">
            <button
              onClick={() => {
                window.my_modal_confirmDeletePPID.close();
              }}
            ...
            <button
              onClick={() => deletePPIDId(pickIdDelete)}
...
export default ConfirmDeletePPID;
