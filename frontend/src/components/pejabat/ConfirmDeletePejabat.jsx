...
const ConfirmDeletePejabat = ({ deletePejabatId, pickIdDelete }) => {
  return (
    <dialog id="my_modal_confirmDeletePejabat" className="modal">
      <form method="dialog" className="modal-box">
        <div className=" flex flex-col items-center justify-center">
          ...
          <div className="flex gap-4">
            <button
              onClick={() => {
                window.my_modal_confirmDeletePejabat.close();
              }}
            ...
            <button
              onClick={() => deletePejabatId(pickIdDelete)}
...
export default ConfirmDeletePejabat;
