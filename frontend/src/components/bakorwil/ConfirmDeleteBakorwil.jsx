...
const ConfirmDeleteBakorwil = ({ deletebakorwilId, pickIdDelete }) => {
  return (
    <div>
      <dialog id="my_modal_confirmDeleteBakorwil" className="modal">
        <form method="dialog" className="modal-box">
          <div className=" flex flex-col items-center justify-center">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => {
                  window.my_modal_confirmDeleteBakorwil.close();
                }}
              ...
              <button
                onClick={() => deletebakorwilId(pickIdDelete)}
...
export default ConfirmDeleteBakorwil;
