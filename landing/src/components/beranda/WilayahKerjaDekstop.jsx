...
const WilayahKerjaDekstop = () => {
  return (
    <>
      {/* Dekstop */}
      <div className="wilayah-kerja mt-12 px-5 md:px-0 hidden lg:inline-block">
        <div className="bg-second rounded-2xl py-5">
          ...
          <div className="grid grid-cols-3 place-items-center gap-y-5">
            <a
              href="https://batukota.go.id/Portal/profil"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.malangkab.go.id/mlg/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.blitarkab.go.id/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.pasuruankab.go.id/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.sidoarjokab.go.id/"
              target="_blank"
              rel="noreferrer"
            >
...
export default WilayahKerjaDekstop;
