...
const CardKegiatan = ({ setPickOfGaleri }) => {
  ...
  const galeriKegiatan = dataGaleri.filter(
    (data) => data.kategori === "Kegiatan"
  );
  ...
  const pageCount = galeriKegiatan.length / galeriPerPage;
