  ...
  return (
    <>
      <div className="md:w-[180%] relative">
        <div className="absolute bottom-0 left-0 right-0 px-4 py-2 bg-[#262626] opacity-70 md:py-4">
          <h3 className="text-sm text-center text-white font-medium md:text-lg">
      ...
      <div className="md:grid items-center relative">
        <div className="absolute bottom-0 left-0 right-0 px-4 py-2 bg-[#262626] opacity-70 md:py-4 md:bottom-[90px]">
          <h3 className="text-sm text-center text-white font-medium md:text-xs">
