import { FaClipboardUser, FaEnvelope, FaFacebook, FaGlobe, FaInstagram, FaLocationDot, FaPhone, FaTwitter } from 'react-icons/fa6';
    ...
    <>
      ...
      <div className="footer px-5 md:px-10 lg:20px bg-dark text-white pb-10">
        ...
        <div className="isi mx-auto flex flex-col gap-4 text-xs md:text-sm mt-7">
          ...
          <a href="https://maps.app.goo.gl/JRkBeyETKrHQNp4M7" target="_blank" rel="noopener noreferrer" className="flex gap-3 mt-3">
          ...
          <a href="mailto:bakorwilmalang@jatimprov.go.id" className="flex gap-3">
          ...
          <a href="https://wa.me/+6281937065659" target="_blank" rel="noopener noreferrer" className="flex gap-3">
            <FaClipboardUser className="self-center" />
            <div className="font-light">
              M. Wildan (0819 3706 5659)
              <div className="h-[2px] w-full bg-white"></div>
            </div>
          </a>
          <a href="https://wa.me/+6281937065659" target="_blank" rel="noopener noreferrer" className="flex gap-3">
        ...
        <div className="isi mx-auto flex flex-col gap-4 text-xs md:text-sm mt-7">
          ...
          <a href="http://www.bakorwilmadiun.jatimprov.go.id/" className="flex gap-3 mt-3">
          ...
          <a href="https://bakorwilbojonegoro.jatimprov.go.id/" className="flex gap-3">
            <FaGlobe className="self-center" />
            <div className="font-light">
              Bakorwil Bojonegoro
              <div className="h-[2px] w-full bg-white"></div>
          ...
          <a href="https://bakorwilpamekasan.jatimprov.go.id/" className="flex gap-3">
            <FaGlobe className="self-center" />
            <div className="font-light">
              Bakorwil Pamekasan
              <div className="h-[2px] w-full bg-white"></div>
          ...
          <a href="https://bakorwiljember.jatimprov.go.id/" className="flex gap-3">
            <FaGlobe className="self-center" />
            <div className="font-light">
              Bakorwil Jember
              <div className="h-[2px] w-full bg-white"></div>
