      ...
      <div className="lg:grid grid-cols-4 gap-20 md:px-10 lg:px-20">
        ...
        <div className="flex flex-col order-last">
          <div className="pengumuman mt-12 md:mt-16 px-5 md:px-0">
            <h1 className="text-xl lg:text-2xl text-center font-semibold text-second">
              Pengumuman
            </h1>
            ...
            <div className="flex justify-center mt-5">
              <Link
                to={"/pengumuman"}
                className="flex items-center h-7 px-3 rounded-lg bg-second text-white hover:bg-birumuda capitalize text-sm"
              >
                Lihat Lainnya
              </Link>
            </div>
        ...
        <div className="berita mt-12 px-5 md:px-0 col-span-3">
          <div className="md:grid grid-cols-2 justify-between items-end">
            <h1 className="text-xl md:text-2xl text-center md:text-left font-semibold text-second">
              Berita Terbaru
            </h1>
            {/* Lihat lainnya */}
          ...
          <div className="flex md:hidden justify-center mt-5">
            <Link
              to={"/berita"}
              className="py-1 px-3 rounded-lg bg-second text-white hover:bg-birumuda capitalize text-sm"
            >
              Lihat Lainnya
            </Link>
          </div>
